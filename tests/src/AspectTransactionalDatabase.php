...
class AspectTransactionalDatabase
{
    ...
    public function error()
    {
        ...
        throw new QueryException($this->db->connection()->getName(), "SELECT date('now')", [], new \Exception);
    }
    ...
    public function multipleDatabaseAppendRecordException()
    {
        ...
        throw new QueryException($this->db->connection('testing_second')->getName(),"SELECT date('now')", [], new \Exception);
    }
